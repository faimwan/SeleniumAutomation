...
namespace GuidedSellerAutomation
{
    public class GuidedSellerValidationMessages
    {
        ...
        public readonly string[] MainChoiceList = { "Kill Weeds", "Cure Lawn Patches", "Cure Plant Disease", "Control Insects", "Control Animals", "Control Rodents" };
